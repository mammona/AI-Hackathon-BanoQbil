...
class QuestionBank {
  ...
  static const List<FarmerAudioQuestion> questions = [
    FarmerAudioQuestion(
      ...
      punjabiHint: 'فصل وچ کیہ روگ نظر آ رہیا اے؟',
      required: true,
      maxAnswerSeconds: 20,
    ),
    FarmerAudioQuestion(
      ...
      punjabiHint: 'ایہ روگ کدوں توں لگا اے؟',
      required: true,
      maxAnswerSeconds: 20,
    ),
    FarmerAudioQuestion(
      id: 'affected_spread',
      audioAsset: 'assets/audio/02_affected_spread.mp3',
      punjabiHint: 'کِنا رقبہ خراب ہویا اے؟',
      required: true,
      maxAnswerSeconds: 20,
    ),
    FarmerAudioQuestion(
      ...
      punjabiHint: 'کیہ ایہ ہور ودھ رہیا اے؟',
      required: true,
      maxAnswerSeconds: 20,
    ),
  ];
